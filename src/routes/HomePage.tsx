...
export default function HomePage() {
  ...
  return (
    <div className="absolute box-border top-16 h-screen-with-nav w-full bg-gradient-to-b justify-center items-top from-blue-50 to-gray-100 p-5 min-w-[420px] overflow-auto">
